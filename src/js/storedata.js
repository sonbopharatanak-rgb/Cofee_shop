...
const Coffee = [
    // --- ក្រុម៖ កាហ្វេ (category: "coffee") ---
    {
        ...
        name: "Espresso", 
        price: 2.50, 
        img: "https://i.pinimg.com/736x/d1/97/3e/d1973eff377fb3477c8be70b5151f87b.jpg",
        desc: "The foundation of most coffee drinks. It is a concentrated shot of coffee brewed by forcing hot water through finely-ground coffee beans under high pressure.",
        category: "coffee",
    ...
    },
    {
        ...
        desc: "A smooth, diluted coffee drink made by pouring hot water over a fresh shot of espresso. It tastes similar to regular brewed black coffee but carries a different aroma.",
        category: "coffee",
    ...
    },
    {
        ...
        name: "Cappuccino",
        price: 3.50,
        img: "https://i.pinimg.com/736x/20/72/91/207291accd4af08d31fbe52ae408f504.jpg",
        desc: "A classic Italian favorite made with equal parts of espresso, steamed milk, and a thick layer of velvety milk foam on top",
        category: "coffee",
    ...
    },
    {
        ...
        price: 4.25,
        img: "https://i.pinimg.com/736x/be/be/17/bebe178990ffe79696a4b5d4ae45e793.jpg",
        desc: "A creamier and milder option compared to a cappuccino. It consists of one or two shots of espresso mixed with a generous amount of steamed milk, finished with a very thin layer of foam.",
        category: "coffee",
    ...
    },
    {
        ...
        name: "Macchiato",
        price: 3.25,
        img: "https://i.pinimg.com/736x/a2/b6/4d/a2b64d0fdf45c2230f266d214ccbb8f4.jpg",
    ...
    {
        id: 6, 
        name: "Mocha (Café Mocha)",
        price: 3.65,
        img: "https://i.pinimg.com/736x/24/3e/12/243e12ced1cdd80c5895b52eef32ddbb.jpg",
        desc: "Fresh steamed milk with vanilla syrup, marked with espresso and caramel drizzle.",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
    {
        ...
        name: "Flat White",
        price: 4.25,
        img: "https://i.pinimg.com/736x/3a/df/d7/3adfd73bb92ffa2daaad008c1a2743da.jpg",
        desc: "Originating from Australia and New Zealand, this drink is created by pouring a velvety layer of (steamed milk with tiny bubbles) over a shot of espresso or ristretto. It has a higher coffee-to-milk ratio than a latte.",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
    {
        ...
        name: "Cortado",
        price: 2.95,
        img: "https://i.pinimg.com/736x/b9/80/7c/b9807c89943277f245a3bed85c52979b.jpg",
        desc: "A perfectly balanced drink consisting of equal parts espresso and warm, steamed milk. The milk reduces the acidity of the espresso without masking its strong flavor.",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
    {
        ...
        name: "Affogato",
        price: 3.45,
        img: "https://i.pinimg.com/webp/236x/2d/b7/45/2db74559ab03684d140535007c8a7c7d.webp",
        desc: "Part beverage, part dessert. An affogato features a scoop of vanilla bean gelato or ice cream in a hot, freshly pulled shot of espresso.",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
    {
        ...
        desc: "Unlike iced coffee (which is hot coffee cooled down), cold brew is made by steeping coarse coffee grounds in room temperature or cold water for 12 to 24 hours, resulting in a smooth, less acidic flavor profile.",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
    {
        ...
        name: "Irish Coffee",
        price: 2.25,
        img: "https://i.pinimg.com/736x/85/98/ca/8598cadc67216b0fc793f1e2ed5a5a05.jpg",
        desc: "Fresh steamed milk with vanilla syrup, marked with espresso and caramel drizzle.",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
    {
        ...
        price: 2.80,
        img: "https://i.pinimg.com/736x/58/78/a2/5878a29b9697e87f306f4c3e5fbb20d6.jpg",
        desc: "Unlike the glass Frappuccinos, Starbucks sells a larger line of sweetened and unsweetened iced coffees (like Medium Roast or Subtly Sweet) in lightweight plastic bottles designed for standard cup holders.",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
    {
        ...
        price: 5.99,
        img: "https://i.pinimg.com/736x/4d/fc/95/4dfc95fb52a161498debed5f295fec16.jpg",
        desc: "A highly popular brand recognized by its distinct bold, geometric plastic bottle profile. Known for a smooth, low-acid cold brew flavor, offering varieties like Unsweetened, Not Too Sweet, and Vanilla.",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
    {
        id: 15, 
        name: "Califia Farms Cold Brew",
        price: 6.49,
        img: "https://i.pinimg.com/736x/42/f6/c4/42f6c49ebcbade366921d373ff252f71.jpg",
        desc: "Packaged in iconic, elegant curved plastic carafes. Califia Farms specializes in dairy-free cold brew blends mixed with almond milk or oat milk, alongside pure black blonde and dark roasts.",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
    {
        ...
        price: 4.70,
        img: "https://i.pinimg.com/736x/d4/fe/88/d4fe88e4ee264722471a7049bc641f3c.jpg",
        desc: "Perfect for those who love their coffee sweet and very creamy. Sold in bright, opaque plastic cartons/bottles in the refrigerated section with flavors like Caramel Macchiato and Hershey’s Chocolate Mocha.",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
    {
        id: 17, 
        name: "Dunkin' Donuts Iced Coffee (Bottled)",
        price: 2.70,
        img: "https://i.pinimg.com/736x/b2/a9/f6/b2a9f654bb07b9e833a135770db56635.jpg",
        desc: "Dunkin’ offers its retail grab-and-go lineup in clear plastic bottles. They are heavily pre-milked and sweetened, imitating their classic drive-thru flavors like Original, French Vanilla, and Girl Scout Cookie inspirations.",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
    {
        id: 18, 
        name: "Boss Coffee (Suntory)",
        price: 3.25,
        img: "https://i.pinimg.com/236x/61/5d/79/615d7912c5ef97fd897b2bd2e8498bb5.jpg",
        desc: "While famous in Japan for its small aluminum flash-brew cans, Boss Coffee manufactures larger versions of its popular Café Au Lait and Black Coffee explicitly in clear plastic bottles for international grocery markets.",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
    {
    ...
    },
    {
        ...
        name: "Matcha Latte",
        price: 6.25,
        img: "https://i.pinimg.com/736x/29/be/70/29be706fc60b2cbcc9de2b59bef778f5.jpg",
        desc: "A white coffee cup with steam rising from it 53581270 royalty free PNG from Vecteezy for your project and explore over a million other illustrations, icons and clipart graphics!",
        category: "coffee",
        qrCode: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=CaramelMacchiato-4.25"
    },
